...
class common {
	...
	// Numéro de version 
	const ZWII_VERSION = '10.0.114.dev';
	...
	public function showContent() {
		...
		echo '<div class="translate">' . $this->core->output['content'] . '</div>';
		 if ($this->getData(['config','i18n',$this->geti18n(),'autoTranslate']) === true && 
			...
			echo '<div id="googTransLogo"><a href="//policies.google.com/terms#toc-content data-lity><img src="' . helper::baseUrl(false) . 'core/module/i18n/ressource/googtrans.png" /></a></div>';
		 }
	}
